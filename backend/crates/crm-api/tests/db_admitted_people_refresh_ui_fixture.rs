...
use crm_api::{
    auth::workspace::ReleaseReadiness, domain::migration::admitted_people_refresh_worker,
    ...
    let worker = tokio::spawn(async move {
        ...
        loop {
            ...
            for _ in 0..32 {
                ...
                let budget =
                    std::fs::read("/private/tmp/crm-mobile004-010e4/migration/worker-units.json")
                        .ok()
