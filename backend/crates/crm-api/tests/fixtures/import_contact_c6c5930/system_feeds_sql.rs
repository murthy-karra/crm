...
struct PersonStateRow {
    ...
    #[sqlx(rename = "by_inquiry!")]
    by_inquiry: bool,
    #[sqlx(rename = "by_reply!")]
    by_reply: bool,
    #[sqlx(rename = "fresh!")]
    fresh: bool,
    #[sqlx(rename = "order_key?")]
...
pub async fn person_state_candidates(
    ...
    let mut rows =
        bind_query!(sqlx::query_as::<_, PersonStateRow>(include_str!("sql/person_state.sql"));
        organization_id.0,
        ...
        params_a.custom_slot(0).and_then(|s| s.text_operand.as_deref()),
        params_a.custom_slot(0).and_then(|s| s.number_min.as_deref()),
        params_a.custom_slot(0).and_then(|s| s.number_max.as_deref()),
        params_a.custom_slot(0).and_then(|s| s.date_min),
        params_a.custom_slot(0).and_then(|s| s.date_max),
        params_a.custom_slot(0).and_then(|s| s.option_ids.as_deref()),
        params_a.custom_slot(1).map(|s| s.field_id),
        params_a.custom_slot(1).map(|s| s.field_type),
        params_a.custom_slot(1).map(|s| s.operation),
        params_a.custom_slot(1).and_then(|s| s.text_operand.as_deref()),
        params_a.custom_slot(1).and_then(|s| s.number_min.as_deref()),
        params_a.custom_slot(1).and_then(|s| s.number_max.as_deref()),
        params_a.custom_slot(1).and_then(|s| s.date_min),
        params_a.custom_slot(1).and_then(|s| s.date_max),
        params_a.custom_slot(1).and_then(|s| s.option_ids.as_deref()),
        params_a.custom_slot(2).map(|s| s.field_id),
        params_a.custom_slot(2).map(|s| s.field_type),
        params_a.custom_slot(2).map(|s| s.operation),
        params_a.custom_slot(2).and_then(|s| s.text_operand.as_deref()),
        params_a.custom_slot(2).and_then(|s| s.number_min.as_deref()),
        params_a.custom_slot(2).and_then(|s| s.number_max.as_deref()),
        params_a.custom_slot(2).and_then(|s| s.date_min),
        params_a.custom_slot(2).and_then(|s| s.date_max),
        params_a.custom_slot(2).and_then(|s| s.option_ids.as_deref()),
        params_a.custom_slot(3).map(|s| s.field_id),
        params_a.custom_slot(3).map(|s| s.field_type),
        params_a.custom_slot(3).map(|s| s.operation),
        params_a.custom_slot(3).and_then(|s| s.text_operand.as_deref()),
        params_a.custom_slot(3).and_then(|s| s.number_min.as_deref()),
        params_a.custom_slot(3).and_then(|s| s.number_max.as_deref()),
        params_a.custom_slot(3).and_then(|s| s.date_min),
        params_a.custom_slot(3).and_then(|s| s.date_max),
        params_a.custom_slot(3).and_then(|s| s.option_ids.as_deref()),
        params_a.custom_slot(4).map(|s| s.field_id),
        params_a.custom_slot(4).map(|s| s.field_type),
        params_a.custom_slot(4).map(|s| s.operation),
        params_a.custom_slot(4).and_then(|s| s.text_operand.as_deref()),
        params_a.custom_slot(4).and_then(|s| s.number_min.as_deref()),
        params_a.custom_slot(4).and_then(|s| s.number_max.as_deref()),
        params_a.custom_slot(4).and_then(|s| s.date_min),
        params_a.custom_slot(4).and_then(|s| s.date_max),
        params_a.custom_slot(4).and_then(|s| s.option_ids.as_deref()),
        params_b.custom_slot(0).map(|s| s.field_id),
        params_b.custom_slot(0).map(|s| s.field_type),
        params_b.custom_slot(0).map(|s| s.operation),
        params_b.custom_slot(0).and_then(|s| s.text_operand.as_deref()),
        params_b.custom_slot(0).and_then(|s| s.number_min.as_deref()),
        params_b.custom_slot(0).and_then(|s| s.number_max.as_deref()),
        params_b.custom_slot(0).and_then(|s| s.date_min),
        params_b.custom_slot(0).and_then(|s| s.date_max),
        params_b.custom_slot(0).and_then(|s| s.option_ids.as_deref()),
        params_b.custom_slot(1).map(|s| s.field_id),
        params_b.custom_slot(1).map(|s| s.field_type),
        params_b.custom_slot(1).map(|s| s.operation),
        params_b.custom_slot(1).and_then(|s| s.text_operand.as_deref()),
        params_b.custom_slot(1).and_then(|s| s.number_min.as_deref()),
        params_b.custom_slot(1).and_then(|s| s.number_max.as_deref()),
        params_b.custom_slot(1).and_then(|s| s.date_min),
        params_b.custom_slot(1).and_then(|s| s.date_max),
        params_b.custom_slot(1).and_then(|s| s.option_ids.as_deref()),
        params_b.custom_slot(2).map(|s| s.field_id),
        params_b.custom_slot(2).map(|s| s.field_type),
        params_b.custom_slot(2).map(|s| s.operation),
        params_b.custom_slot(2).and_then(|s| s.text_operand.as_deref()),
        params_b.custom_slot(2).and_then(|s| s.number_min.as_deref()),
        params_b.custom_slot(2).and_then(|s| s.number_max.as_deref()),
        params_b.custom_slot(2).and_then(|s| s.date_min),
        params_b.custom_slot(2).and_then(|s| s.date_max),
        params_b.custom_slot(2).and_then(|s| s.option_ids.as_deref()),
        params_b.custom_slot(3).map(|s| s.field_id),
        params_b.custom_slot(3).map(|s| s.field_type),
        params_b.custom_slot(3).map(|s| s.operation),
        params_b.custom_slot(3).and_then(|s| s.text_operand.as_deref()),
        params_b.custom_slot(3).and_then(|s| s.number_min.as_deref()),
        params_b.custom_slot(3).and_then(|s| s.number_max.as_deref()),
        params_b.custom_slot(3).and_then(|s| s.date_min),
        params_b.custom_slot(3).and_then(|s| s.date_max),
        params_b.custom_slot(3).and_then(|s| s.option_ids.as_deref()),
        params_b.custom_slot(4).map(|s| s.field_id),
        params_b.custom_slot(4).map(|s| s.field_type),
        params_b.custom_slot(4).map(|s| s.operation),
        params_b.custom_slot(4).and_then(|s| s.text_operand.as_deref()),
        params_b.custom_slot(4).and_then(|s| s.number_min.as_deref()),
        params_b.custom_slot(4).and_then(|s| s.number_max.as_deref()),
        params_b.custom_slot(4).and_then(|s| s.date_min),
        params_b.custom_slot(4).and_then(|s| s.date_max),
        params_b.custom_slot(4).and_then(|s| s.option_ids.as_deref()))
        .fetch_all(conn)
        .await?;
...
pub async fn call_membership(
    ...
    let rows = bind_query!(sqlx::query_as::<_, CallMembershipRow>(include_str!("sql/call_membership.sql"));
        organization_id.0,
        ...
        params.custom_slot(0).and_then(|s| s.text_operand.as_deref()),
        ...
        params.custom_slot(1).and_then(|s| s.text_operand.as_deref()),
        ...
        params.custom_slot(2).and_then(|s| s.text_operand.as_deref()),
        ...
        params.custom_slot(3).and_then(|s| s.text_operand.as_deref()),
        ...
        params.custom_slot(4).and_then(|s| s.text_operand.as_deref()),
...
pub async fn call_only_candidates(
    ...
    let rows = bind_query!(sqlx::query_as::<_, CallOnlyRow>(include_str!("sql/call_only.sql"));
        organization_id.0,
        params.stage_ids.as_deref(),
        params.assigned_user_ids.as_deref(),
        params.assigned_include_unassigned,
