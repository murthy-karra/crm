...
pub(super) const CANDIDATE_SQL: &str = "SELECT id,organization_id,lease_token FROM migration_people_refresh WHERE state IN ('preparing','queued','running') ORDER BY created_at,id LIMIT 1";
