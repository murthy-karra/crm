...
import requests
QA=Path('__PRIVATE_QA_ROOT__')
API='http://127.0.0.1:13010/api'
vals={}
...
cases=[('complete','Acme History QA','alice@acme.test','Alice Anderson','carol@acme.test','Carol Chen'),('cancel','Best History QA','bob@best.test','Bob Baker','dave@best.test','Dave Diaz'),('budget','Budget History QA','elsa@budget.test','Elsa Ellis','fred@budget.test','Fred Foster')]
...
print('Synthetic history prerequisites ready; no history capture prepared.',flush=True)
