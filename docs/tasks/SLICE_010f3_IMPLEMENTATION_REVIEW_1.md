...
| 2 | P1 TENANT/CONTRACT | New child/claim/observation/alias/remainder references lack the frozen composite Organization/owner provenance FKs | Migration writer implementing additive009 and negative persistence checks |
| 3 | P1 FIDELITY | Tags unique to erased or identity-mismatched settled cohort People disappear from catalog coverage | Migration writer implementing retained coverage and held-Person regressions |
