...
**COMPLETE AND MERGED TO LOCAL MAIN — approved by the user on 2026-09-06.**
...
Implementation commit: `2af023c`; merged locally after the user's explicit
commit/merge approval. Push and deployment were not performed.
...
The user-approved local commit and merge are complete.
...
Local commit and merge are complete; push and deployment are not included.
