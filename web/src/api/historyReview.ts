...
export const historyKinds = ['person_imported', 'inquiry_received', 'routing_decision', 'assignment_changed', 'stage_changed', 'contact_attempted', 'call_completed', 'correspondence', 'fub_event_record_imported', 'fub_call_record_imported', 'fub_text_record_imported', 'person_admitted', 'person_recovered'] as const
