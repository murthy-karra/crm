...
export function useImportAccess(namespace: 'people-imports' | 'metadata-imports' | 'activity-imports' | 'activity-review' | 'history-captures' | 'history-imports' | 'history-review' | 'core-change-reports' | 'people-refreshes' = 'people-imports') {
  const { data: me } = useMe()
