...
import { type ActivityChoice, type ActivityRole, type ActivityMapping, type ActivityPatch, type ActivityTarget } from '../../api/activityImports'
import { useActivityReaders } from './activityFamily'
const { fetchActivityMappings, useActivityAccess } = useActivityReaders()
