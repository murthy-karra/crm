...
import { type ActivityRecord, type ActivityResult, type ActivityPage } from '../../api/activityImports'
import { useActivityReaders } from './activityFamily'
const { fetchActivityRecords, fetchActivityResults, useActivityAccess } = useActivityReaders()
